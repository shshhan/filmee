...
public class ReviewPageDTO {
	...
	private int offset;			// 현재 페이지의 시작 레코드의 인덱스 번호
...
//	}
	...
	public ReviewPageDTO(Integer film_id, CriteriaFilmReview cri, int totalAmount) {
		...
		int amount = cri.getAmount();				// 한 페이지당 보여줄 레코드 건수 추출 from Criteria
		int pagesPerPage = cri.getPagesPerPage();	// 각 페이지 아래에 보여줄, 페이지번호의 개수 추출 from Criteria 
