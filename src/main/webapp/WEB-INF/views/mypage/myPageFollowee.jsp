    ...
    <script>
	    ...
	    $(function() {
		    ...
		    $('a#prev, a#next').on('click', function(e) {				
				...
				paginationForm.attr('action', '/mypage/followee');
        ...
        <div id='container'>
            ...
            <div id='mypage_mid_menu'>
                ...
                <ul class="nav nav-tabs">
                    <li class="nav-item">
                      <a class="nav-link" href="/mypage/follower?userid=${pageMaker.criF.userid}&currPage=1&amount=10&pagesPerPage=5">Following</a>
                    </li>
                    
                    <li class="nav-item">
                      <a class="nav-link active" aria-current="page" href="#">Followee</a>
                    </li>                    
			...
			<c:forEach items="${followees}" var="followees">
                      ...
                      <ul class="pagination">
                        ...
                        <c:forEach begin='${pageMaker.startPage}' end='${pageMaker.endPage}' var='pageNum'>
						    <li class="${pageMaker.criF.currPage == pageNum ? 'page-item active' : 'page-item'}">
						    	<a class="page-link" href="/mypage/followee?userid=${pageMaker.criF.userid}&currPage=${pageNum}&amount=${pageMaker.criF.amount}&pagesPerPage=${pageMaker.criF.pagesPerPage}">${pageNum}</a>
						    </li>
						</c:forEach>
